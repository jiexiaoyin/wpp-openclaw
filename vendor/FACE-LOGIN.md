...
| 凭证 | 是什么 | 在哪拿 | 用途 |
|---|---|---|---|
| **tokenKey** (客户端密钥) | 平台授权凭证 | [cloud.wechatpadpro.com/user/access-tokens](https://cloud.wechatpadpro.com/user/access-tokens) 创建 | **部署 vendor 的前提** — 填 `config/app.conf` 的 `user_token_key` |
