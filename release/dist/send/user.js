...
export function makeWppUser(ctx) {
    ...
    return {
        ...
        bindQQ: (qq, password) => dispatch("/User/BindQQ", { account: Number(qq), password }),
        ...
        bindingMobile: (mobile, code) => dispatch("/User/BindingMobile", { mobile, verifycode: code }),
        ...
        privacySettings: (opt, value) => dispatch("/User/PrivacySettings", { function: opt, value }),
        ...
        reportMotion: (steps, deviceId = "", deviceType = "ipad") => dispatch("/User/ReportMotion", { deviceId, deviceType, stepCount: steps }),
        ...
        setAlisa: (alias) => dispatch("/User/SetAlisa", { alisa: alias }),
        /** /User/SetPasswd — 修改密码
        ...
        setPasswd: (newPwd, ticket) => dispatch("/User/SetPasswd", { newPassword: newPwd, ticket }),
        /** /User/UpdateProfile — 修改个人信息 (swagger User.UpdateProfileParamDoc {nickName, signature, sex, city, country, province}) */
        updateProfile: (nickname, signature, sex) => dispatch("/User/UpdateProfile", {
            nickName: nickname ?? "",
            signature: signature ?? "",
            sex: sex ?? 0,
            city: "",
        ...
        uploadHeadImage: (imgBase64) => dispatch("/User/UploadHeadImage", { base64: imgBase64 }),
