...
export function defaultAffectionConfig() {
    return {
        ...
        model: undefined, // placeholder,运行时由 cfg.model 提供;类型占位仅为兼容 AffectionConfig.model?: string
...
//# sourceMappingURL=affection.js.map