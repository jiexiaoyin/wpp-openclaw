...
import type { WppAccountCtx } from "./factory.js";
 ...
 */
export function makeWppSend(ctx: WppAccountCtx) {
  return {
...
export type WppSend = ReturnType<typeof makeWppSend>;
