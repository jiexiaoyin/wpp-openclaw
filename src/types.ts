...
export interface WppAccountConfig {
  ...
  /** v1.3.1 LLM-INTENT: LLM 判断模型 (默认 "MiniMax-M2.7-highspeed" (v1.4.0 P0-fix 19:31 hardcode 消除, 走 schema default)) */
   ...
   */
  ai?: {
    /** 统一判断模型 (默认 "MiniMax-M2.7-highspeed" (v1.4.0 P0-fix 19:31 hardcode 消除, 走 schema default)) */
    judgeModel?: string;
    /** LLM 调用超时毫秒 (默认 5000) */
    timeoutMs?: number;
  };
